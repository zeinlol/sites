 ...
 * @version $Id: userfields.php 8842 2015-05-04 20:34:47Z Milbo $
 */
			...
			foreach ($_selection as $_fld) {
				...
				switch( $_fld->name ) {
					...
					case 'password2':
						...
						$_return['fields'][$_fld->name]['formcode'] = '<input type="password" id="' . $_prefix.$_fld->name . '_field" name="' . $_prefix.$_fld->name .'" size="30" class="inputbox'.($_fld->required ? ' required' : ''). '" />'."\n";
