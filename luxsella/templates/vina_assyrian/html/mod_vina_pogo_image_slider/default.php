...
$doc->addScript(JURI::root().'/templates/'. $app->getTemplate() .'/js/jquery.pogo-slider.js');
...
<!-- slideshow block -->
<div id="vina-pogo-slider<?php echo $module->id; ?>" class="vina-pogo-slider pogoSlider <?php echo $params->get ('moduleclass_sfx') ?>">
	...
	<div class="pogoSlider-slide">
		...
		<?php if(!empty($text) && $captionBlock): ?>
			<div class="container button-wrapper block-wrapper"><?php echo $text; ?></div>
		<?php endif; ?>
	</div>
	<?php endforeach; ?>
</div>
