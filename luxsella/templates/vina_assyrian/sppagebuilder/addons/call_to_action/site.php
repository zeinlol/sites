...
function sp_call_to_action_addon($atts){
	...
	$button_output = '<a target="' . $button_target . '" href="' . $button_url . '" class="sppb-btn sppb-btn-' . $button_type . ' sppb-btn-' . $button_size . ' ' . $button_block . ' vina-action" role="button">' . $button_text . '</a>';

	$output  = '<div class="sppb-addon sppb-addon-cta ' . $class . '" style="' . $style . '">';

	if($button_position=='right') {

		$output .= '<div class="sppb-row call-box">';

		$output .= '<div class="sppb-title">';
		...
		$output .= '<div class="sppb-text-right sppb-button">';
