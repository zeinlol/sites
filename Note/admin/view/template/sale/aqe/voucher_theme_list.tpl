						...
						<tbody>
							...
							<tr>
								...
								<td style="width:1px" class="text-center">
									<input type="checkbox" name="selected[]" value="<?php echo $voucher_theme['voucher_theme_id']; ?>"<?php if ($voucher_theme['selected']) { ?> checked <?php } ?>/>
								</td>
										<?php break;
										case 'image': ?>
								<td class="<?php echo $column_info[$col]['align']; ?><?php echo ($column_info[$col]['qe_status']) ? ' ' . $column_info[$col]['type'] : ''; ?>" id="<?php echo $col . "-" . $voucher_theme['voucher_theme_id']; ?>">
									<img src="<?php echo $voucher_theme['thumb']; ?>" alt="<?php echo $voucher_theme['name']; ?>" class="img-thumbnail" data-id="<?php echo $voucher_theme['voucher_theme_id']; ?>" data-image="<?php echo $voucher_theme['image']; ?>" />
								</td>
										<?php break;
										case 'action': ?>
								<td class="<?php echo $column_info[$col]['align']; ?> action">
									...
									<?php if ($action['url']) { ?>
										<a href="<?php echo $action['url']; ?>" class="btn btn-default btn-sm <?php echo $action['type']; ?> <?php echo $action['class']; ?>" id="<?php echo $action['action'] . "-" . $voucher_theme['voucher_theme_id']; ?>" data-toggle="tooltip" data-container="body" title="<?php echo $action['title']; ?>"><i class="fa fa-<?php echo $action['icon']; ?>"></i><?php echo $action['name']; ?></a>
									<?php } else { ?>
										<button type="button" class="btn btn-default btn-sm action <?php echo $action['type']; ?> <?php echo $action['class']; ?>" id="<?php echo $action['action'] . "-" . $voucher_theme['voucher_theme_id']; ?>" data-toggle="tooltip" data-container="body" title="<?php echo $action['title']; ?>" data-column="<?php echo $action['action']; ?>"<?php echo ($action['rel']) ? ' data-rel="' . $action['rel'] . '"' : ''; ?>><?php if ($action['icon']) { ?><i class="fa fa-<?php echo $action['icon']; ?>"></i><?php } ?><?php echo $action['name']; ?></button>
									<?php } ?>
									<?php } ?>
									</div>
								</td>
										<?php break;
										default: ?>
								<td class="<?php echo $column_info[$col]['align']; ?><?php echo ($column_info[$col]['qe_status']) ? ' ' . $column_info[$col]['type'] : ''; ?>" id="<?php echo $col . "-" . $voucher_theme['voucher_theme_id']; ?>"><?php echo $voucher_theme[$col]; ?></td>
										<?php break;
									}
								} ?>
							</tr>
...
bull5i.filter=function(){url='index.php?route=sale/voucher_theme&token=<?php echo $token; ?>&sort=<?php echo $sort; ?>&order=<?php echo $order; ?>';
