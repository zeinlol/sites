<?php
/**
 * @version		$Id: default.php 1 2014-08-29 17:44 sakis Terz $
...
$document->addStyleSheet(JURI::base().'components/com_customfilters/assets/css/mybootstrap.css');
...
$value=!empty($cfInputs['q'])?$cfInputs['q']:'';
