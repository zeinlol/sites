...
<div class="row login-users text-center">
	<div class="col-sm-4 text-center" style="border: 1px solid #e5e5e5;padding: 21px;margin: 0 auto; float: none;">
		<div class="login<?php echo $this->pageclass_sfx?>">
			...
			<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-validate">
				...
				<div class="form-group">
					<button type="submit" class="vina-button">
