...
?>
<style type="text/css" scoped>fieldset.additionalFields {display:none;}</style>
...
if (0==$params->get('hideform') OR (1==$params->get('hideform') AND  (!isset($validated) OR (isset($validated) AND 0==$validated)))) 
{
	...
	if (is_object($form)) require JModuleHelper::getLayoutPath('mod_qlform', 'default_form'.ucwords($params->get('stylesHtmltemplate','bootstrap')));
}
